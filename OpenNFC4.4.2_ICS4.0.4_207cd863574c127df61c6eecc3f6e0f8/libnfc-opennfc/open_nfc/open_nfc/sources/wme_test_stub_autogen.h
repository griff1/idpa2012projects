...
#define P_TEST_INTERFACE_UUID { 0x55, 0xBB, 0x5E, 0x06, 0x05, 0x6B, 0x95, 0xC2, 0x84, 0x45, 0x65, 0x53, 0xC3, 0x13, 0xAE, 0x6A, }
...
#define OPEN_NFC_PRODUCT_SIMPLE_VERSION 4.4.2
#define OPEN_NFC_PRODUCT_SIMPLE_VERSION_S  { '4', '.', '4', '.', '2',  0 }
#endif /* #ifndef OPEN_NFC_PRODUCT_SIMPLE_VERSION */
#ifndef OPEN_NFC_PRODUCT_VERSION
#define OPEN_NFC_PRODUCT_VERSION v4.4.2 beta
#define OPEN_NFC_PRODUCT_VERSION_S  { 'v', '4', '.', '4', '.', '2', ' ', 'b', 'e', 't', 'a',  0 }
#endif /* #ifndef OPEN_NFC_PRODUCT_VERSION */
#ifndef OPEN_NFC_PRODUCT_VERSION_BUILD
#define OPEN_NFC_PRODUCT_VERSION_BUILD v4.4.2 beta (Build 0)
#define OPEN_NFC_PRODUCT_VERSION_BUILD_S  { 'v', '4', '.', '4', '.', '2', ' ', 'b', 'e', 't', 'a', ' ', '(', 'B', 'u', 'i', 'l', 'd', ' ', '0', ')',  0 }
