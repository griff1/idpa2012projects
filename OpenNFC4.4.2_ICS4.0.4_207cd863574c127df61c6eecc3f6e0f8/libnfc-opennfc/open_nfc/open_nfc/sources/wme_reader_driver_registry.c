...
collision_detected:
...

   {
      ...
      for (i=0; i<pReaderDriverRegistry->nCollisionProtocolsSize; i++)
      {
         PDebugTrace("         @ReactivateDetection() collision filters %d, %08x", i, pReaderDriverRegistry->aCollisionProtocols[i]);
      }
