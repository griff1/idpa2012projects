            ...
            uint32_t             nReceivedAPDUBufferMaxLength)
{
   ...
   if (pChannel == null)
   {
      /* pChannel is null if called from P7816ExchangeApduInternal or with the DEPRECATED behaviour of P7816ExchangeAPDU */
                  ...
                  W_ERROR nResult )
{
   ...
   if (nResult == W_SUCCESS)
   {
      nResult = static_P7816CreateChannelInstance(pContext, p7816Connection, nChannelReference, &hChannel);
      if(nResult != W_SUCCESS)
      {
