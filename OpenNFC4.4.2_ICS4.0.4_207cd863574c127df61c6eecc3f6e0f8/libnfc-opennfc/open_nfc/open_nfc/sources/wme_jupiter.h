...
/**
 * @brief Process the AID list returned by the NFC Controller and call the SE
 * if necessary.
 *
 ...
 *
 * @return   W_SUCCESS if the processing is done synchronously,
 *           W_ERROR_RETRY if the operation is pending.
 *           another value if an error is detected.
 **/
