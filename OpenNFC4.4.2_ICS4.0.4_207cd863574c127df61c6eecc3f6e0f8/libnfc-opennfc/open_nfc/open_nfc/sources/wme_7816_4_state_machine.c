...
#define P_7816_4_P2_SELECT_FILE      0x04 /* FCP template in answer */
                  ...
                  tP7816SmInstance* pInstance)
{
   ...
   pInstance->current.aReaderToCard[0] = P_7816_4_CLA; /* CLA byte is set later */
   pInstance->current.aReaderToCard[1] = P_7816_4_INS_MANAGE_CHANNEL;
   pInstance->current.aReaderToCard[2] = 0x00; /* P1 */
                  ...
                  uint32_t nAIDLength)
{
   ...
   {
      pInstance->current.aReaderToCard[0] = P_7816_4_CLA; /* CLA byte is set later */
      pInstance->current.aReaderToCard[1] = P_7816_4_INS_SELECT;
      pInstance->current.aReaderToCard[2] = 0x00; /* P1 */
      pInstance->current.aReaderToCard[3] = P_7816_4_P2_SELECT_FILE; /* P2 - Return FCP */
   ...
   pInstance->current.aReaderToCard[0] = P_7816_4_CLA; /* CLA byte is set later */
   pInstance->current.aReaderToCard[1] = P_7816_4_INS_SELECT;
   pInstance->current.aReaderToCard[2] = P_7816_4_INS_SELECT_AID_P1; /* P1 */
   pInstance->current.aReaderToCard[3] = P_7816_4_INS_SELECT_AID_P2; /* P2 */
                  ...
                  tP7816SmChannel* pChannel)
{
   ...
   pInstance->current.aReaderToCard[0] = P_7816_4_CLA; /* CLA byte is set later */
   pInstance->current.aReaderToCard[1] = P_7816_4_INS_MANAGE_CHANNEL;
   pInstance->current.aReaderToCard[2] = 0x80; /* P1 */
